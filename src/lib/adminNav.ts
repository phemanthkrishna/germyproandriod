import { ClipboardList, Users, DollarSign, Package, Store, MapPin, Wrench, BarChart2, Tag, Bell, ShieldCheck } from 'lucide-react'
...
export const NAV_ROLE_ACCESS: Record<AdminRole, string[]> = {
  ...
  manager: [
    ...
    '/admin/cities', '/admin/services', '/admin/promos', '/admin/campaigns',
  ],
